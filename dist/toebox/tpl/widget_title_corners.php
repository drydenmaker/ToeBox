<div class="<?php print $container_class ?>" style="background: url(<?php print $background ?>) <?php print $background_style ?>">
    ...
    <div class="<?php print $description_class ?> visible-md-inline visible-lg-inline visible-xl-inline">
    ...
    <div class="<?php print $description_class ?> visible-xs-inline visible-sm-inline">
        <h2><?php echo get_bloginfo( 'description', 'display' ); ?></h2>
    </div>
</div>